...
class DownloadsControllerTest < ActionController::TestCase
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post :create, download: { attachment: @download.pdf, description: @download.description, title: @download.title }
    end
  ...
  test "should update download" do
    patch :update, id: @download, download: { attachment: @download.pdf, description: @download.description, title: @download.title }
    assert_redirected_to download_path(assigns(:download))
  end
